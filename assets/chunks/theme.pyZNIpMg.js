const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.B53Xl9FL.js","assets/chunks/framework.BFOyFJ_i.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.B53Xl9FL.js"), true ? __vite__mapDeps([0,1]) : void 0));
